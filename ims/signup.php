...
<body style="background-image:url(img/black.jpg)">
  <div class="container" style="margin-top:175px;background-image: url(img/black.png);">
    <div class="row align-items-center">
      <div class="col-12">
        <div class="row align-items-center">
          <div class="col-lg-6 mb-4">
            <h2 style="color: #049; font-weight: bold">Insurance Management System</h2>
            <p class="mb-4" style="color: #fff; font-weight: bold">Insurance Managemant System is a web application which is used to tracking the details about the insurance policy, customer details and company details. The company tries to give insurance policy holders quick access to their insurance policy details, modify or update the datails and even renew an expired insurance policy. All this, with a single click on your computer, at the comfort of your home.
