                    ...
                    <form action="policyreg.php" method="post">
                        ...
                        <div class="input-group-icon mt-10">
                            <div class="form-select" id="default-select" align="center">
                                ...
                                <select style="margin-left: 20px" name="state">
                        ...
                        <div class="mt-10">
                            <input type="text" name="annual" placeholder="Annual Income (indian rupees)" required class="single-input">
                        </div>
                        <div class="mt-10">
                    ...
                    <div class="blog_right_sidebar">
                        ...
                        <aside class="single_sidebar_widget post_category_widget">
                            ...
                            <ul class="list cat-list">
                                <li>
                                    <a href="#" class="d-flex">
                                        <p style="color: #f84b67">Update policy Details</p>
                                ...
                                <li>
                                    <a href="companyreg.php" class="d-flex">
                                        <p>company policy Registration</p>
